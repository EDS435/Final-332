...
class account extends React.Component {
    ...
    renderList() {
        ...
        return accttrans.map(char => {
            return (
                <tbody>
                <tr style={{backgroundColor: 'white', fontWeight: 'inherit'}}>
                    <td style={{backgroundColor: 'whitesmoke', fontWeight: 'inherit', color: 'black'}}>{char._id}</td>
    ...
    render() {
        ...
        return(
                ...
                <div>
                    <h2 style={{textAlign: 'center', marginTop: '40px', color: 'black', fontWeight: 'inherit'}}> This is the
                    ...
                    <h3 style={{textAlign: 'center', marginTop: '40px', color: 'black', fontWeight: 'inherit'}}> Acount
                        Balance: {acct[0].balance} </h3>
                    <Container style={{display: 'flex'}}>
                    <h4 style={{marginLeft:'180px', marginTop: '50px',color: 'black', fontWeight: 'inherit'}}> Deposit
                        Money</h4>

                    <Form onSubmit={this.onAddMoneySubmit} style={{marginLeft: '20px', marginTop:'50px'}}>
                        <Form.Group>
                            <h4 style={{fontWeight: 'inherit', fontSize: '20px'}}> Enter ID</h4>
                    ...
                    <h4 style={{marginLeft:'180px', marginTop: '50px',color: 'black', fontWeight: 'inherit'}}> Withdraw
                        Money</h4>
                    ...
                    <Container style={{display: 'flex'}} >
                        ...
                        <h4 style={{marginLeft:'180px', marginTop: '50px',color: 'black', fontWeight: 'inherit'}}> Edit Account Name</h4>

                        <Form onSubmit={this.onNameSubmit} style={{marginLeft: '20px', marginTop:'50px'}}>
                            <Form.Group>

                                <h4 style={{fontWeight: 'inherit', fontSize: '20px', textAlign: 'left'}}> Enter Name</h4>
                    ...
                    <h1 style={{textAlign: 'center', margin: '40px', color: 'black', fontWeight: 'inherit'}}> List of All
                        Transactions</h1>
                    ...
                    <Table style={{margin: '10'}} striped bordered hover>
                        ...
                        <thead>
                        <tr style={{backgroundColor: 'darkblue', fontWeight: 'inherit', color: 'white'}}>
                            <td>ID</td>
                            <td>Account ID</td>
